<template>
  <div class="chat-app-warp">
    <!-- <div class="top_line">
      <div class="gdut">GDUT</div>
      <div class="gdut-font">
        <h2>基于Ukey和国密算法的即时通讯认证系统</h2>
        <h5>Instant Chat Authentication System Based on Ukey and National Security Algorithm</h5>
      </div>
    </div> -->
   <div class="left-banner"></div>
   <div class="right-banner" v-if="!loginUser.id">
     <!-- <div class="right-top"> Welcome to the instant messaging authentication system based on Ukey and national security algorithms</div> -->
    
     <div class="center">
       <div class="fenge">
          <h4>让我们为您登录</h4>
          <h3>基于Ukey和国密算法的即时通讯认证系统</h3>
        </div> 
          <!-- <h6 >没有账户请联系公司管理员</h6> -->
     </div>
     <div class="bottom"> <strong>登录系统步骤</strong>
       <br>
       <img src="../assets/images/buttom.jpg" alt="">
    ...
    <!-- //pc端的 -->
    <!-- 判断loginUser.id是否存在 如果不存在 这个div是不会显示出来 -->
...
<style scoped lang="less">
  .left-banner{
    ...
    height: 100%;
    width: 50%;
   background-image: url(../assets/images/webwxgetmsgimg.jpg);
